...
import cx_Oracle
try:
            con=cx_Oracle.connect("system/anmol@localhost/xe")
            cur=con.cursor()
            ...
            class Admin:
                        def closedAcc(self):
                                    cur.execute("SELECT * FROM ANMOL.printhistory")
                                    q=cur.fetchall()
                                    if q!=[]:
            ...
            class Account:
                        def addressChange(self,custid,addr):
                                    cur.execute("""UPDATE ANMOL.customer SET address=:1 WHERE customer_id=:2""",{'1':addr,'2':custid})
                                    con.commit()
                                    print("Address changed successfully")
                                    
                        def makeDeposit(self,bal,accn):
                                    cur.execute("SELECT balance FROM ANMOL.customer WHERE customer_id=:1",{'1':accn})
                                    q=cur.fetchall()
                                    if q!=[]:
                                                bal1=q[0][0]+bal
                                                cur.execute("""UPDATE ANMOL.customer SET balance=:1 WHERE customer_id=:2""",{'1':bal1,'2':accn})
                                                con.commit()
                                                cur.execute("SELECT balance FROM ANMOL.customer WHERE customer_id=:1",{'1':accn})
                                                q=cur.fetchall()
                                                print("\nDeposit Success\nCurrent balance: "+str(q[0][0]))
                                                cur.execute("""INSERT INTO ANMOL.printstatement VALUES (SYSDATE,:1,'Credit',:2,:3)""",{'1':accn,'2':bal,'3':bal1})
                                                con.commit()
                                    else:
                                                print("\nAccount No. does not exists")

                        def makeWithdrawal(self,bal,accn,custid):
                                    cur.execute("SELECT account_type FROM ANMOL.customer WHERE customer_id=:1",{'1':accn})
                                    acctyp=cur.fetchall()
                                    if acctyp!=[]:
                                                acctyp=acctyp[0][0]
                                                if accn==custid:
                                                            ...
                                                            if acctyp=='s':
                                                                        if q[0][0]<bal:
                                                                                    ...
                                                                                    q=cur.fetchall()
                                                                                    print("\nWithdrawal Success\nCurrent balance: "+str(q[0][0]))
                                                                                    cur.execute("INSERT INTO ANMOL.printstatement VALUES(SYSDATE,:1,'Debit',:2,:3)",(accn,bal,bal1))
                                                                                    con.commit()
                                                            if acctyp=='c':
                                                                        if q[0][0]<bal:
                                                                                    print("\nCannot withdraw. Current balance: "+str(q[0][0]))
                        ...
                        def transferMoney(self,bal,accn,custid):
                                    cur.execute("SELECT account_type FROM ANMOL.customer WHERE customer_id=:1",{'1':custid})
                                    acctyp=cur.fetchall()
                                    acctyp=acctyp[0][0]
                                    cur.execute("SELECT balance FROM ANMOL.customer WHERE customer_id=:1",{'1':custid})
                                    q=cur.fetchall()
                                    if q[0][0]<bal:
                                                ...
                                                if acctyp=='s':
                                                            while True:
                                                                        ...
                                                                        if ch==1:
                                                                                    ...
                                                                                    q=cur.fetchall()
                                                                                    if q!=[]:
                                                                                                cur.execute("""UPDATE ANMOL.customer SET balance=:1 WHERE customer_id=:2""",{'1':bal1,'2':custid})
                                                                                                con.commit()
                                                                                                cur.execute("INSERT INTO ANMOL.printstatement VALUES(SYSDATE,:1,'Debit',:2,:3)",(custid,bal,bal1))
                                                                                                con.commit()
                                                                                                cur.execute("SELECT balance FROM ANMOL.customer WHERE customer_id=:1",{'1':accn})
                                                                                                q=cur.fetchall()
                                                                                                bal1=q[0][0]+bal
                                                                                                cur.execute("""UPDATE ANMOL.customer SET balance=:1 WHERE customer_id=:2""",{'1':bal1,'2':accn})
                                                                                                con.commit()
                                                                                                cur.execute("INSERT INTO ANMOL.printstatement VALUES(SYSDATE,:1,'Credit',:2,:3)",(accn,bal,bal1))
                                                                                                con.commit()
                                                                                                cur.execute("SELECT balance FROM ANMOL.customer WHERE customer_id=:1",{'1':custid})
                                                                                                q=cur.fetchall()
                                                                                                #cur.execute("SELECT balance FROM ANMOL.customer WHERE customer_id=:1",{'1':accn}))
                        ...
                        def display(self,custid):
                                    cur.execute("select * from ANMOL.printstatement WHERE customer_id=:1 order by customer_id,Account_Date",{'1':custid})
                                    qury=cur.fetchall()
                                    print tabulate(qury,headers=['Date','Account No.','Transaction type','Amount','Balance'])

                        def accountCls(self,custid):
                                    cur.execute("INSERT INTO ANMOL.printhistory VALUES(:1,SYSDATE)",{'1':custid})
                                    con.commit()
                                    cur.execute("SELECT balance FROM ANMOL.customer WHERE customer_id=:1",{'1':custid})
                                    q=cur.fetchall()
                                    cur.execute("SELECT address,city,state,pincode FROM ANMOL.customer WHERE customer_id=:1",{'1':custid})
                                    q1=cur.fetchall()
                                    print("\nYour Amount: "+str(q[0][0])+" will be sent to the address: "+q1[0][0]+","+q1[0][1]+","+q1[0][2]+","+str(q1[0][3]))
                                    cur.execute("DELETE FROM ANMOL.customer WHERE customer_id=:1",{'1':custid})
                                    con.commit()
                                    print("Account closed successfully")
                        def fdaccount(self,custid,b):
                                    cur.execute("INSERT INTO ANMOL.fd VALUES(:1,SYSDATE,:2)",{'1':custid,'2':b})
                                    print("\nFD Ammoun deposit successful")
                                    con.commit()
                        def fddisplay(self,custid):
                                    cur.execute("select * from ANMOL.fd where c_id=:1",{'1':custid})
                                    qury=cur.fetchall()
                                    if qury!=[]:
            ...
            class Customer:
                        ...
                        def signUp(self,acctyp,name,gender,mob,addr,state,city,pincode,email,password,balance):
                                    cur.execute("""INSERT INTO  ANMOL.customer VALUES (ANMOL.C_ID_VAL.NEXTVAL,:pram0,:pram1,:pram2,:pram3,:pram4,:pram5,:pram6,:pram7,:pram8,:pram9,:pram10,'0',SYSDATE)""",(acctyp,name,gender,mob,addr,state,city,pincode,email,password,balance))
                                    con.commit()
                                    cur.execute("SELECT max(customer_id) FROM ANMOL.customer")
                                    q=cur.fetchall()
                                    cur.execute("UPDATE ANMOL.customer SET Account_No=:1 Where customer_id=:1",{'1':q[0][0]})
                                    print("\nYou have successfully signed up")
                                    con.commit()
                                    cur.execute("INSERT INTO ANMOL.printstatement VALUES(SYSDATE,:1,'Credit',:2,:2)",{'1':q[0][0],'2':balance})
                                    con.commit()
                                    print("\nYour Customer Id and Account Number is: "+str(q[0][0]))
                        def signIn(self,custid,psswd):
                                    accnt=Account();
                                    cur.execute("SELECT password FROM ANMOL.customer WHERE customer_id=:1",{'1':custid})
                                    q=cur.fetchall()
                                    if q!=[]:
                                                if psswd==q[0][0]:
                                                            ...
                                                            while True:
                                                                        ...
                                                                        if ch==1:
                                                                                    ...
                                                                                    print("\nenter the FD balance")
                                                                                    b=raw_input();
                                                                                    accnt.fdaccount(custid,b)
                                                                        elif ch==9:
                                                                                    accnt.fddisplay(custid)
                                                                        else:
                        ...
                        def adminSignIn(self,adid,psswd):
                                    cur.execute("SELECT password FROM ANMOL.admin WHERE admin_id=:1",{'1':adid})
                                    q=cur.fetchall()
                                    if q!=[]:
                                                if psswd==q[0][0]:
                                                            print("\nSigned In Successful")
                                    ...
                                    if self.num==1:
                                                ...
                                                while True:
                                                            if c>=1 and c<=3:
                                                                        ...
                                                                        print("\nYour account is locked")
                                                                        cur.execute("DELETE FROM ANMOL.admin WHERE customer_id=:1",{'1':self.customerId})
                                                                        con.commit()
                                                                        break;
